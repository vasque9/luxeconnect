...
import { listings, getUser, favorites as favApi, auth } from '@/lib/api';
          ...
          <div className="flex gap-2">
            {user ? (
              <>
                ...
                <button onClick={() => { auth.logout(); window.location.href = '/'; }} className="text-xs border border-border rounded-lg px-3 py-1.5 text-muted hover:text-crimson transition">Salir</button>
              </>
            ) : (
